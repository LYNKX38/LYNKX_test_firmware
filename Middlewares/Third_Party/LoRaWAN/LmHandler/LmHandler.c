...
LmHandlerErrorStatus_t LmHandlerConfigure( LmHandlerParams_t *handlerParams )
{
    ...
    MW_LOG(TS_OFF, VLEVEL_H, "###### DevAddr:     %02X:%02X:%02X:%02X\r\n",
    ...
    MW_LOG(TS_OFF, VLEVEL_H, "###### KMS ENABLED \r\n");
#endif /* LORAWAN_KMS == 1 */
...
void LmHandlerJoin( ActivationType_t mode, bool forceRejoin )
{
    ...
    {
        MW_LOG(TS_OFF, VLEVEL_H, "ERROR: OTAA mode not implemented\r\n");
        while (1);
    }
    ...
    {
        MW_LOG(TS_OFF, VLEVEL_H, "ERROR: ABP mode not implemented\r\n");
        while (1);
    }
