...
#define HCI_READ_PACKET_NUM_MAX      20//10
...
#define SUPERV_TIMEOUT      60 //max 0x0C80
...
#if (BLE2_DEBUG == 1)
  #include <stdio.h>
  #define PRINT_DBG(...)              APP_LOG(0,1,__VA_ARGS__)
#else
  #define PRINT_DBG(...)
#endif
