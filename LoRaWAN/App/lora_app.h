...
#define APP_TX_EMERGENCY_DUTYCYCLE      60000
...
extern uint8_t OLNPayload[LORAWAN_APP_DATA_BUFFER_MAX_SIZE];
...
/* USER CODE BEGIN EFP */
/**
  * @brief callback from main application to update LORA/LORAWAN behaviour
  */
