...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN TD */
extern DMA_HandleTypeDef hdma_tim17_ch3;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(MISO_GPIO_Port, SCK_Pin|MISO_Pin|MOSI_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PB10     ------> TIM2_CH3
    */
    GPIO_InitStruct.Pin = CHG_FLAG_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(CHG_FLAG_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB10     ------> TIM2_CH3
    */
    HAL_GPIO_DeInit(CHG_FLAG_GPIO_Port, CHG_FLAG_Pin);
  ...
  */
  ...
  else if(huart->Instance==USART2)
  {
	  ...
	  */
	    ...
	    PA2     ------> USART2_TX
	    */
	    GPIO_InitStruct.Pin = RXD_GNSS_Pin|TXD_GNSS_Pin;
	    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
	    GPIO_InitStruct.Pull = GPIO_NOPULL;
	    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    HAL_GPIO_DeInit( TXD_GPIO_Port, TXD_Pin|RXD_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA2     ------> USART2_TX
    */
    HAL_GPIO_DeInit(TXD_GNSS_GPIO_Port, RXD_GNSS_Pin|TXD_GNSS_Pin);
