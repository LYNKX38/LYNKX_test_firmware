...
#if defined AUTO_GEN_WORKAROUND
...
#endif /* AUTO_GEN_WORKAROUND */

  UTIL_ADV_TRACE_SetVerboseLevel(1);
...
{
  BATMSUpdate(); // Measure the battery and update variable

  return battery_level;  /* 1 (very low) to 254 (fully charged) */
}
